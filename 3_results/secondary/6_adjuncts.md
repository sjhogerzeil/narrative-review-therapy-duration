...
*What role do adjuncts play, and are they sequential or concurrent with primary therapy?*
...
| reddit-2023-how-long-in-therapy | 5 | u/merry_bird: reading and self-reflection alongside therapy. Reddit community itself as form of peer support | Concurrent | Self-study and peer support as unacknowledged adjuncts |
| reddit-2024-what-feels-like-after | 5 | Sobriety programs, ACA (12-step), inner child work, meditation, body scans, mindfulness, relational restructuring (leaving marriage, going NC). Counselling as one of 10+ listed activities | Concurrent + sequential | Therapy-plus is extreme; counselling was one ingredient among many |
| reddit-2023-fully-healed-how-long | 5 | u/ElishaAlison: safe relationship with boyfriend as essential precondition — he helped extract from abusive environment. Only talk therapy formally, but relational safety was the adjunct | Concurrent | Safe relationship as non-therapeutic adjunct that enabled therapy to work |
| reddit-2025-full-cure-how-long | 5 | Wellbutrin (pharmacological clarity), supportive spouse, self-directed systematic reflection, AI-assisted processing (u/Icy-Birthday-6864) | Concurrent | Medication enabled cognition; spouse enabled safety; self-reflection enabled readiness |
| reddit-2021-cant-heal-while-surviving | 5 | Environmental change (moving, going NC, leaving relationships) as the decisive factor. Therapy alone insufficient — environmental safety as non-therapeutic adjunct | Concurrent/prerequisite | Thread's central finding: therapy without environmental safety is insufficient |
| reddit-2021-how-long-after-therapy-feel | 5 | Supportive husband as relational resource. DBT grounding techniques as self-practice | Concurrent | Relational stability + self-practice techniques |
| reddit-2024-recovered-cptsd | 5 | MDMA (MAPS protocol), somatic massage (9 months), medications, "just about every book I can find," "hundreds of hours on articles, Reddit threads and videos," relationships, AuDHD support, living alone, stable income | Concurrent | Therapy-plus is extensive; therapy was backbone but supported by rich ecology of adjuncts |
| reddit-2025-stages-healing-stage3 | 5 | Stage 3 is self-directed: self-soothing, self-compassion practice, boundary-setting, accepting reduced productivity. Stage 4 emergence: connecting with community | Concurrent → sequential | Formal therapy provided tools; Stage 3 integration happens in life, not sessions |
