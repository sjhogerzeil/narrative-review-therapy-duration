...
## What the counterevidence actually shows
...
|-------------------|------------|
| Read the full synthesis | [`4_discussion/1_synthesis.md`](4_discussion/1_synthesis.md) |
| Check a specific source | [`3_results/sources/`](3_results/sources/) — one file per source, organised by layer |
| See how data was extracted | [`3_results/primary/`](3_results/primary/) and [`3_results/secondary/`](3_results/secondary/) |
